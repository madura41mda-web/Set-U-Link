...
('33333333-3333-4333-a333-333333333301', 'Severe Fluoride Contamination in Angara Borewells', 'Borewells in 3 hamlets contain fluoride above permissible limits causing bone fluorosis among children.', 'water', 'Ranchi', ST_SetSRID(ST_MakePoint(85.4521, 23.3892), 4326)::geography, 'https://images.unsplash.com/photo-1541888946425-d0fbb186a5b3?auto=format&fit=crop&w=800&q=80', 'reported', 42, '22222222-2222-4222-a222-222222222202', 'citizen', 68.5, NOW() - INTERVAL '5 days'),
('33333333-3333-4333-a333-333333333302', 'Primary School Lacks Sanitation and Drinking Water', 'Govt school with 180 students lacks separate toilets for girls and has no running water source.', 'education', 'Dhanbad', ST_SetSRID(ST_MakePoint(86.4211, 23.8105), 4326)::geography, 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=800&q=80', 'reported', 88, '22222222-2222-4222-a222-222222222203', 'panchayat', 82.0, NOW() - INTERVAL '12 days'),
('33333333-3333-4333-a333-333333333303', 'Lack of Cold Storage for Tomato Farmers in Ormanjhi', 'Over 40 tons of seasonal tomato crop rots annually due to absence of solar-powered cold storage micro-units.', 'agriculture', 'Ranchi', ST_SetSRID(ST_MakePoint(85.4851, 23.4912), 4326)::geography, 'https://images.unsplash.com/photo-1595855759920-86582396756a?auto=format&fit=crop&w=800&q=80', 'reported', 115, '22222222-2222-4222-a222-222222222204', 'citizen', 85.0, NOW() - INTERVAL '8 days'),
('33333333-3333-4333-a333-333333333304', 'Broken Culvert Isolating Ghatshila Tribal Villages', 'Monsoon stream overflow broke culvert connecting 4 tribal hamlets to hospital and secondary school.', 'infra', 'East Singhbhum', ST_SetSRID(ST_MakePoint(86.4802, 22.5811), 4326)::geography, 'https://images.unsplash.com/photo-1517649763962-0c623266010b?auto=format&fit=crop&w=800&q=80', 'reported', 64, '22222222-2222-4222-a222-222222222203', 'panchayat', 74.0, NOW() - INTERVAL '15 days'),
('33333333-3333-4333-a333-333333333305', 'Absence of Primary Health Center Cold Chain for Vaccines', 'Sub-center near Bermo lacks solar refrigeration causing vaccine wastage during regular power cuts.', 'health', 'Bokaro', ST_SetSRID(ST_MakePoint(85.9405, 23.7745), 4326)::geography, 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&w=800&q=80', 'reported', 92, '22222222-2222-4222-a222-222222222205', 'ulb', 89.0, NOW() - INTERVAL '18 days'),
('33333333-3333-4333-a333-333333333306', 'High Arsenic Content in Handpump Water near Chas', 'Water test kits show elevated arsenic levels in 8 community handpumps.', 'water', 'Bokaro', ST_SetSRID(ST_MakePoint(86.0125, 23.6301), 4326)::geography, 'https://images.unsplash.com/photo-1581244277943-fe4a9c777189?auto=format&fit=crop&w=800&q=80', 'reported', 53, '22222222-2222-4222-a222-222222222206', 'citizen', 71.0, NOW() - INTERVAL '2 days'),
('33333333-3333-4333-a333-333333333307', 'Soil Erosion Degrading Paddy Fields in Ichak Block', 'Uncontrolled rainwater runoff eroding topsoil across 120 acres of fertile rainfed land.', 'agriculture', 'Hazaribagh', ST_SetSRID(ST_MakePoint(85.4215, 24.1102), 4326)::geography, 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?auto=format&fit=crop&w=800&q=80', 'reported', 37, '22222222-2222-4222-a222-222222222202', 'citizen', 59.0, NOW() - INTERVAL '4 days'),
('33333333-3333-4333-a333-333333333308', 'Lack of Silk Weaving Yarn Processing Machinery', 'Tussar silk weavers in Dumri block struggle with manual yarn reeling resulting in low income.', 'livelihood', 'Giridih', ST_SetSRID(ST_MakePoint(86.0501, 24.0305), 4326)::geography, 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?auto=format&fit=crop&w=800&q=80', 'reported', 78, '22222222-2222-4222-a222-222222222204', 'citizen', 77.5, NOW() - INTERVAL '9 days'),
('33333333-3333-4333-a333-333333333309', 'Open Waste Dumping near Pilgrimage Corridor', 'Solid waste accumulation causing groundwater leaching near temple entry zone.', 'sanitation', 'Deoghar', ST_SetSRID(ST_MakePoint(86.6912, 24.4891), 4326)::geography, 'https://images.unsplash.com/photo-1530587191325-3db32d826c18?auto=format&fit=crop&w=800&q=80', 'reported', 104, '22222222-2222-4222-a222-222222222205', 'ulb', 83.0, NOW() - INTERVAL '14 days'),
('33333333-3333-4333-a333-333333333310', 'Frequent Coal Dust Air Pollution in Jharia Market', 'Uncovered coal transport trucks causing respiratory illness among local residents and shopkeepers.', 'health', 'Dhanbad', ST_SetSRID(ST_MakePoint(86.4150, 23.7420), 4326)::geography, 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=800&q=80', 'reported', 140, '22222222-2222-4222-a222-222222222206', 'citizen', 91.0, NOW() - INTERVAL '20 days'),
('33333333-3333-4333-a333-333333333311', 'Non-functional Solar Mini-grid in Mandar Block', 'Battery failure left 60 households without electricity for community lighting and study centers.', 'infra', 'Ranchi', ST_SetSRID(ST_MakePoint(85.0890, 23.4560), 4326)::geography, 'https://images.unsplash.com/photo-1509391365360-2e959784a276?auto=format&fit=crop&w=800&q=80', 'reported', 49, '22222222-2222-4222-a222-222222222202', 'citizen', 62.0, NOW() - INTERVAL '10 days'),
('33333333-3333-4333-a333-333333333312', 'Pond Siltation Reducing Fish Farming Yield in Patratu', 'Heavy silt influx from unlined drains reduced water depth by 60% in community aquaculture pond.', 'livelihood', 'Ramgarh', ST_SetSRID(ST_MakePoint(85.2910, 23.6380), 4326)::geography, 'https://images.unsplash.com/photo-1560493676-04071c5f467b?auto=format&fit=crop&w=800&q=80', 'reported', 31, '22222222-2222-4222-a222-222222222204', 'citizen', 54.0, NOW() - INTERVAL '3 days'),
('33333333-3333-4333-a333-333333333313', 'Lack of STEM Lab Equipment in Kasturba Gandhi Balika Vidyalaya', 'Residential girls school needs basic lab instruments and computer stations for 250 tribal students.', 'education', 'West Singhbhum', ST_SetSRID(ST_MakePoint(85.8120, 22.5610), 4326)::geography, 'https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=800&q=80', 'reported', 86, '22222222-2222-4222-a222-222222222203', 'panchayat', 80.0, NOW() - INTERVAL '11 days'),
('33333333-3333-4333-a333-333333333314', 'Untreated Effluent Discharge into Subarnarekha River tributary', 'Small-scale industrial washings polluting river stretch used for domestic cattle water.', 'water', 'East Singhbhum', ST_SetSRID(ST_MakePoint(86.2250, 22.7890), 4326)::geography, 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=800&q=80', 'reported', 110, '22222222-2222-4222-a222-222222222205', 'ulb', 87.0, NOW() - INTERVAL '17 days'),
